<template>
  <div id="menu">
    <div id="position">
      ...
      <img class="image3" src="../assets/images/menu/image3.png" alt="">
      <img class="image4" src="../assets/images/menu/image4.png" alt="">
...
<style lang="scss">
  #menu {
    ...
    .gif {
      ...
      width: $percent;
      position: absolute;
      top: calc((100% - #{$percent}) / 2);
      left: calc((100% - #{$percent}) / 2);
      right: 0;
      bottom: 0;
    }
  }
